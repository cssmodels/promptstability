...
class OllamaAnnotator:
    '''This is a simple wrapper that uses Ollama to annotate text.'''
...
class OpenAIAnnotator:
    '''This is a simple wrapper for the OpenAI API, to annotate text.'''
    def __init__(self, model, apikey = None) -> None:
        self.apikey = apikey
        self.model = model
